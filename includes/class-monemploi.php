...
class Monemploi {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Monemploi_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Monemploi_Loader. Orchestrates the hooks of the plugin.
	 * - Monemploi_i18n. Defines internationalization functionality.
	 * - Monemploi_Admin. Defines all hooks for the admin area.
	 * - Monemploi_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-monemploi-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-monemploi-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-monemploi-admin.php';
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/partials/monemploi-new-employeur-widget.php';
		
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/partials/monemploi-new-employee-widget.php';
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/monemploi-functions.php';
        	...
        	require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/shortcodes/monemploi-resume-from.php';
        	
        	require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/shortcodes/monemploi-candidacy-dashboard.php';
	 ...
	 *
	 * Uses the Monemploi_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Monemploi_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Monemploi_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Monemploi_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Monemploi_Loader    Orchestrates the hooks of the plugin.
	 */
