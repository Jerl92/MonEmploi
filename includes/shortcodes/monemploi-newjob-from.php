        ...
        $author_id = get_post_field( 'post_author', $postid );
			?><div id="monemploi-new-form">
				...
				<?php if(isset($postid) && $author_id = get_current_user_id()){ ?>
					<input type="text" class="monemploi_add_job_text" name="monemploi_job_title" id="monemploi_job_title" value="<?php echo get_the_title($postid); ?>">
				<?php } else { ?>
                    			<input type="text" class="monemploi_add_job_text" name="monemploi_job_title" id="monemploi_job_title">
				<?php } ?>
				...
				<?php if(isset($postid) && $author_id = get_current_user_id()){ ?>
					<input type="number" class="monemploi_add_salaire" name="monemploi_add_salaire" id="monemploi_add_salaire" value="<?php echo get_post_meta( $postid, 'my_salaire_key', true); ?>" style="width: 100px;">
				<?php } else { ?>
					<input type="number" class="monemploi_add_salaire" name="monemploi_add_salaire" id="monemploi_add_salaire" style="width: 100px;">
				<?php } ?>
				...
				<?php if(isset($postid) && $author_id = get_current_user_id()){ ?>
					<input type="number" class="monemploi_add_heures" name="monemploi_add_heures" id="monemploi_add_heures" value="<?php echo get_post_meta( $postid, 'my_add_heures_key', true); ?>" style="width: 100px;">
				<?php } else { ?>
					<input type="number" class="monemploi_add_heures" name="monemploi_add_heures" id="monemploi_add_heures" style="width: 100px;">
				<?php } ?>
				...
				<?php } else { ?>
					<button class="ns_submit" data-object-status="new" data-object-id="0">
