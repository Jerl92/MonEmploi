    		...
    		if(curr_month!=="curr"){
              ...
              var o = 0;
                      jQuery('ul.startonmonday li').each(function(index, element) {
                          lielement.push([parseInt(element.innerHTML)]);
                      });
    
                      jQuery('ul.Thursdayofpayroll li').each(function(index, element) {
                          Thursdaypayroll.push([parseInt(element.innerHTML)]);
                      });
                ...
                jQuery.each(lielement, function(index, element) {
                	endofpaymonth.push([lielement[index+1]]);
                });
			    ...
			    date.setDate(date.getDate());			
			    var formattedDate = (date.getMonth() + 1) + '/' + date.getDate() + '/' + date.getFullYear();
                            word.push([formattedDate, myArray[1], myArray[2], myArray[3], timeunixpayday]);
                      });
