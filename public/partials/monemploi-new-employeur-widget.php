...
function monemploi_new_employeurs_widget() {
	register_widget( 'monemploi_new_employeurs_widgets');
}
add_action( 'widgets_init', 'monemploi_new_employeurs_widget' );

class monemploi_new_employeurs_widgets extends WP_Widget {
	public function __construct() {
		// Instantiate the parent object
		parent::__construct(

			// Base ID of your widget
			'monemploi_new_employeurs_widgets', 

			// Widget name will appear in UI
			__('monemploi_new_employeurs_widgets', 'monemploi'), 
